...
public class XSCFacade {
    ...
    public static void main(String[] args) throws Throwable {
        ...
        try {
            ClassLoader cl = ClassLoaderBuilder.createProtectiveClassLoader(XSCFacade.class.getClassLoader(), v);

            Class driver = cl.loadClass("com.leansoft.mxjc.Driver");
